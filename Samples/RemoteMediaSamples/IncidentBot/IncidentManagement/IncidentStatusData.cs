...
namespace Sample.IncidentBot.IncidentStatus
{
    ...
    public class IncidentStatusData
    {
        ...
        /// <summary>
        /// Gets the bot's meeting correlation id.
        /// </summary>
        public Guid BotMeetingCorrelationId { get; private set; }
        ...
        public void UpdateBotMeetingCallId(string callId, Guid correlationId)
        {
            this.BotMeetingCallId = callId;
            this.BotMeetingCorrelationId = correlationId;
        }
        ...
        /// <param name="callId">The call id.</param>
        /// <param name="correlationId">The correlation id.</param>
        public void UpdateResponderNotificationCallId(string responderId, string callId, Guid correlationId)
        {
            ...
            if (responderData != null)
            {
                ...
                responderData.NotificationCorrelationId = correlationId;
            }
        }
        ...
        /// <param name="callId">The call id.</param>
        /// <param name="correlationId">The correlation id.</param>
        public void UpdateResponderMeetingCallId(string responderId, string callId, Guid correlationId)
        {
            this.responderStatusDictionary.TryGetValue(responderId, out IncidentResponderStatusData responderData);
            ...
            if (responderData != null)
            {
                ...
                responderData.MeetingCorrelationId = correlationId;
            }
        }
