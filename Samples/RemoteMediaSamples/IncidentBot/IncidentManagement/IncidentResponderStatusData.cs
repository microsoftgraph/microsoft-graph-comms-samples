...
namespace Sample.IncidentBot.IncidentStatus
{
    ...
    public class IncidentResponderStatusData
    {
        ...
        /// <summary>
        /// Gets or sets the correlatino id which called from bot.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the correlatino id of the meeting leg to responder.
        /// </summary>
        public Guid MeetingCorrelationId { get; set; }
    }
}
