...
@{
    AllNodes = @(
        @{
            ...
            DirectoryPresent            = @(
                'F:\Source\InstallLogs', 'F:\API\ICB', 'F:\Build\ICB'
            )
            ...
            AppReleaseDSCAppPresent     = @(
                @{
                    ...
                    BuildFileName     = 'F:\Build\ICB\componentBuild.json'
                    SleepTime         = '10'
                }
            )
            ...
            NewServicePresent           = @(
                @{
                    Name        = 'IncidentBotService'
                    Path        = 'F:\API\ICB\IncidentBot.exe'
                    State       = 'Running'
                    StartupType = 'Automatic'
                    Description = 'Incident Bot Service'
                }
            )
