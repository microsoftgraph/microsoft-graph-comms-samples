...
$filestocopy = @(
    ...
    @{
        SourcePath      = "$PSScriptRoot\..\templates\avb-build-OrgName.yml"
        DestinationPath = "$PSScriptRoot\..\..\..\..\..\..\.github\workflows\avb-build-${OrgName}.yml"
        TokenstoReplace = @(
    ...
    @{
        SourcePath      = "$PSScriptRoot\..\templates\avb-infra-OrgName.yml"
        DestinationPath = "$PSScriptRoot\..\..\..\..\..\..\.github\workflows\avb-infra-${OrgName}.yml"
        TokenstoReplace = @(
            @{ Name = '{OrgName}'; Value = $OrgName },
            @{ Name = '{Location}'; Value = $Location },
            @{ Name = '{BranchName}'; Value = $BranchName }
