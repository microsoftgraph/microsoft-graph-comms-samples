...
namespace Sample.PsiBot.FrontEnd.Bot
{
    ...
    public class BotMediaStream
    {
        ...
        public BotMediaStream(ILocalMediaSession mediaSession, CallHandler callHandler, Pipeline pipeline, ITeamsBot teamsBot, Exporter exporter, IGraphLogger logger)
        {
            ...
            this.mediaFrameSourceComponent.Audio.Write("ParticipantAudio", exporter);
            this.mediaFrameSourceComponent.Video.Write("ParticipantVideo", exporter, true);

            teamsBot.ScreenShareOut.Write("BotScreen", exporter, true);
            teamsBot.AudioOut.Write("BotAudio", exporter);
            teamsBot.VideoOut.Write("BotVideo", exporter, true);
        ...
        public async Task ShutdownAsync()
        {
            ...
            // Just out-smarting the style cop.
        ...
        /// <summary>
        /// Save screenshots when we receive audio from subscribed participant.
        /// </summary>
        /// <param name="sender">
        /// The sender.
        /// </param>
        ...
        {
            this.logger.Error($"[VbssOnMediaStreamFailure({e.ToString()})]");
        }
    }
}
