...
namespace Sample.PsiBot.FrontEnd.Http
{
    /// <summary>
    /// HTTP route constants for routing requests to CallController methods.
    /// </summary>
    public static class HttpRouteConstants
    {
        ...
        /* not included in spotlight branch
        /// <summary>
        /// Route prefix for all incoming requests related to chat messages.
        /// </summary>
        public const string MessagesRoutePrefix = "api/messages";
        */
